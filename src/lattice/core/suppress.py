...
def apply_acceptances(findings: list[Finding], acceptances: list[Acceptance]) -> list[Finding]:
    ...
    for finding in findings:
        reason = next((a.reason for a in acceptances if a.matches(finding)), None)
