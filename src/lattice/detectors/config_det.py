...
class ConfigDetector(Detector):
    ...
    def _certificate_assets(self, path: PurePath, line: int, body: str) -> Iterator[CryptoAsset]:
    ...
    def _public_key_assets(self, path: PurePath, line: int, body: str) -> Iterator[CryptoAsset]:
